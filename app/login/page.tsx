                ...
                <div className="w-full max-w-md space-y-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                            <input type="checkbox" id="terms" className="w-5 h-5 rounded border-slate-200 text-slate-900 focus:ring-slate-900" />
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-5 bg-[#111111] text-white rounded-2xl font-black text-[13px] uppercase tracking-widest hover:bg-black transition-all shadow-xl shadow-black/10 active:scale-[0.98] disabled:opacity-70"
                        >
                    ...
                    <div className="text-center">
                        <p className="text-sm font-bold text-slate-400">
                            ...
                            <Link href="/signup" className="text-orange-600 hover:underline">Register</Link>
                        </p>
                    </div>
                </div>
            </div>
